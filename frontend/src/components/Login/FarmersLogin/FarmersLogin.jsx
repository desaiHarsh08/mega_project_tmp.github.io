...
import farmersLogin from '../../../assets/farmers-login.png';
    ...
    <div>
      ...
      <div className='login-container h-[100vh] flex flex-col md:flex-row'>
        <div className="left py-7  w-full  md:w-1/3  flex flex-col items-center justify-center bg-[#f0f8ff]" >
          ...
          <img src={farmersLogin} alt='loginImg' className='w-40 sm:w-56 md:w-96 my-7 sm:my-20 hover:scale-125 transition-all duration-300 ' />
        </div>
